...
{
  new (message_memory) svan_msgs::msg::JointState(_init);
}

void JointState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<svan_msgs::msg::JointState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointState_message_member_array[4] = {
  {
    ...
    offsetof(svan_msgs::msg::JointState, gait_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(svan_msgs::msg::JointState, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(svan_msgs::msg::JointState, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(svan_msgs::msg::JointState, effort),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointState_message_members = {
  ...
  4,  // number of fields
  sizeof(svan_msgs::msg::JointState),
...
get_message_type_support_handle<svan_msgs::msg::JointState>()
{
  return &::svan_msgs::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, svan_msgs, msg, JointState)() {
  return &::svan_msgs::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
