...
#ifndef SVAN_MSGS__MSG__DETAIL__MOTOR_GAIN_MULTIPLIER__FUNCTIONS_H_
#define SVAN_MSGS__MSG__DETAIL__MOTOR_GAIN_MULTIPLIER__FUNCTIONS_H_
 ...
 * calls
 * svan_msgs__msg__MotorGainMultiplier__init().
...
/**
 * It calls
 * svan_msgs__msg__MotorGainMultiplier__fini()
 ...
 * svan_msgs__msg__MotorGainMultiplier__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * svan_msgs__msg__MotorGainMultiplier__Sequence__fini()
 * on the array,
...
#endif  // SVAN_MSGS__MSG__DETAIL__MOTOR_GAIN_MULTIPLIER__FUNCTIONS_H_
