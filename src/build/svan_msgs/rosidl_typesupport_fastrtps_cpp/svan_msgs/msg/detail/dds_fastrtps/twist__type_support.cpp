...
#include "svan_msgs/msg/detail/twist__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svan_msgs::msg::Twist;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const svan_msgs::msg::Twist *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<svan_msgs::msg::Twist *>(
    untyped_ros_message);
...
{
  return &svan_msgs::msg::typesupport_fastrtps_cpp::_Twist__handle;
}
