...
#include "svan_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svan_msgs::msg::Position;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const svan_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<svan_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  return &svan_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
