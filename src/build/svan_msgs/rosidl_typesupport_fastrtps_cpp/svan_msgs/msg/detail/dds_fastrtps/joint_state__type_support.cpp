...
#include "svan_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const svan_msgs::msg::JointState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  svan_msgs::msg::JointState & ros_message)
{
  // Member: gait_id
  cdr >> ros_message.gait_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svan_msgs::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const svan_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<svan_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  return &svan_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, svan_msgs, msg, JointState)() {
  return &svan_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
