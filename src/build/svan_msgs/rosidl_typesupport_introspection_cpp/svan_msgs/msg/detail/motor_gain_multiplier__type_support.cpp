...
{
  new (message_memory) svan_msgs::msg::MotorGainMultiplier(_init);
}

void MotorGainMultiplier_fini_function(void * message_memory)
{
  auto typed_message = static_cast<svan_msgs::msg::MotorGainMultiplier *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorGainMultiplier_message_member_array[2] = {
  {
    ...
    offsetof(svan_msgs::msg::MotorGainMultiplier, kp_scale),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(svan_msgs::msg::MotorGainMultiplier, kd_scale),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorGainMultiplier_message_members = {
  ...
  2,  // number of fields
  sizeof(svan_msgs::msg::MotorGainMultiplier),
...
get_message_type_support_handle<svan_msgs::msg::MotorGainMultiplier>()
{
  return &::svan_msgs::msg::rosidl_typesupport_introspection_cpp::MotorGainMultiplier_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, svan_msgs, msg, MotorGainMultiplier)() {
  return &::svan_msgs::msg::rosidl_typesupport_introspection_cpp::MotorGainMultiplier_message_type_support_handle;
}
