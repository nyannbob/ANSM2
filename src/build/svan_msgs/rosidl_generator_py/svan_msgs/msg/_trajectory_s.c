...
bool svan_msgs__msg__trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("svan_msgs.msg._trajectory.Trajectory", full_classname_dest, 36) == 0);
  }
  svan_msgs__msg__Trajectory * ros_message = _ros_message;
  {  // gait_id
...
PyObject * svan_msgs__msg__trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("svan_msgs.msg._trajectory");
