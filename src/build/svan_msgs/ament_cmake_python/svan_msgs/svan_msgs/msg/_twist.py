...
class Twist(metaclass=Metaclass_Twist):
    ...
    _fields_and_field_types = {
        'linear': 'svan_msgs/Position',
        'angular': 'svan_msgs/Position',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from svan_msgs.msg import Position
        self.linear = kwargs.get('linear', Position())
        from svan_msgs.msg import Position
        self.angular = kwargs.get('angular', Position())
    ...
    def linear(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'linear' field must be a sub message of type 'Position'"
        self._linear = value
    ...
    def angular(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Position), \
                "The 'angular' field must be a sub message of type 'Position'"
        self._angular = value
