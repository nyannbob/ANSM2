...
bool svan_msgs__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("svan_msgs.msg._position.Position", full_classname_dest, 32) == 0);
  }
  svan_msgs__msg__Position * ros_message = _ros_message;
  {  // x
...
PyObject * svan_msgs__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("svan_msgs.msg._position");
