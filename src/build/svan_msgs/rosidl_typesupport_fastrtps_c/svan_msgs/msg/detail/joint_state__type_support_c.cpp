...
#include "svan_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_c.h"
...
using _JointState__ros_msg_type = svan_msgs__msg__JointState;
...
size_t get_serialized_size_svan_msgs__msg__JointState(
  const void * untyped_ros_message,
...
static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_svan_msgs__msg__JointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_svan_msgs
size_t max_serialized_size_svan_msgs__msg__JointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svan_msgs__msg__JointState;
    is_plain =
      (
...
static size_t _JointState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_svan_msgs__msg__JointState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, svan_msgs, msg, JointState)() {
