...
#include "svan_msgs/msg/detail/pose_euler__rosidl_typesupport_fastrtps_c.h"
...
#include "svan_msgs/msg/detail/euler_xyz__functions.h"  // orientation
#include "svan_msgs/msg/detail/position__functions.h"  // position
...
using _PoseEuler__ros_msg_type = svan_msgs__msg__PoseEuler;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PoseEuler__ros_msg_type * ros_message = static_cast<const _PoseEuler__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PoseEuler__ros_msg_type * ros_message = static_cast<_PoseEuler__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_svan_msgs__msg__PoseEuler(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PoseEuler__ros_msg_type * ros_message = static_cast<const _PoseEuler__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PoseEuler__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_svan_msgs__msg__PoseEuler(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_svan_msgs
size_t max_serialized_size_svan_msgs__msg__PoseEuler(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svan_msgs__msg__PoseEuler;
    is_plain =
      (
...
static size_t _PoseEuler__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_svan_msgs__msg__PoseEuler(
...
static message_type_support_callbacks_t __callbacks_PoseEuler = {
  "svan_msgs::msg",
  "PoseEuler",
...
static rosidl_message_type_support_t _PoseEuler__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PoseEuler,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, svan_msgs, msg, PoseEuler)() {
  return &_PoseEuler__type_support;
}
