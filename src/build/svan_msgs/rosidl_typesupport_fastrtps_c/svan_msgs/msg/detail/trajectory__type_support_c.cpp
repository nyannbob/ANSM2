...
#include "svan_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _Trajectory__ros_msg_type = svan_msgs__msg__Trajectory;
...
size_t get_serialized_size_svan_msgs__msg__Trajectory(
  const void * untyped_ros_message,
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_svan_msgs__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_svan_msgs
size_t max_serialized_size_svan_msgs__msg__Trajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = svan_msgs__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_svan_msgs__msg__Trajectory(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, svan_msgs, msg, Trajectory)() {
